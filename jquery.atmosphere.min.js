...
a.transport,f.onabort=function(){N(!0)},f.onerror=function(){e.error=!0;try{e.status=XMLHttpRequest.status}catch(a){e.status=500}e.status||(e.status=500);e.errorHandled||(p(),g())});f.onreadystatechange=function(){if(!I){e.error=null;var h=!1,k=!1;if("streaming"===a.transport&&2<a.readyState&&4===f.readyState)p(),g();else{a.readyState=f.readyState;"streaming"===a.transport&&3<=f.readyState?k=!0:"long-polling"===a.transport&&4===f.readyState&&(k=!0);H(c);if("polling"!==a.transport){var v=200;4===f.readyState&&
(v=1E3<f.status?0:f.status);if(300<=v||0===v){e.errorHandled=!0;p();g();return}a.enableProtocol&&b.firstMessage||2!==f.readyState||V(a)}else 4===f.readyState&&(k=!0);if(k)if(k=f.responseText,0===d.trim(k).length&&"long-polling"===a.transport)f.hasData?f.hasData=!1:z(f,a,0);else{f.hasData=!0;W(f,c);if("streaming"===a.transport)if(d.browser.opera)d.atmosphere.iterate(function(){if(500!==e.status&&f.responseText.length>a.lastIndex){try{e.status=f.status,e.headers=da(f.getAllResponseHeaders()),W(f,c)}catch(b){e.status=
404}H(c);e.state="messageReceived";var d=f.responseText.substring(a.lastIndex);a.lastIndex=f.responseText.length;(h=E(d,a,e))||w();ha(f,a)}else if(400<e.status)return a.lastIndex=f.responseText.length,!1},0);else{if(v=k.substring(a.lastIndex,k.length),h=E(v,a,e),a.lastIndex=k.length,h)return}else h=E(k,a,e);try{e.status=f.status,e.headers=da(f.getAllResponseHeaders()),W(f,a)}catch(m){e.status=404}e.state=a.suspend?0===e.status?"closed":"messageReceived":"messagePublished";(k="streaming"!==b.transport&&
"polling"!==b.transport)&&!a.executeCallbackBeforeReconnect&&z(f,a,0);0===e.responseBody.length||h||w();k&&a.executeCallbackBeforeReconnect&&z(f,a,0);ha(f,a)}}}};f.send(a.data);Z=!0}else"debug"===a.logLevel&&d.atmosphere.log(a.logLevel,["Max re-connection reached."]),s(0,"maxRequest reached")}}function ca(b,a,g){var f=a.url;null!=a.dispatchUrl&&"POST"===a.method&&(f+=a.dispatchUrl);f=J(a,f);f=d.atmosphere.prepareURL(f);g&&(b.open(a.method,f,!0),0<a.connectTimeout&&(a.id=setTimeout(function(){0===
a.requestCount&&(p(),G("Connect timeout","closed",200,a.transport))},a.connectTimeout)));c.withCredentials&&"withCredentials"in b&&(b.withCredentials=!0);c.dropHeaders||(b.setRequestHeader("X-Atmosphere-Framework",d.atmosphere.version),b.setRequestHeader("X-Atmosphere-Transport",a.transport),null!=a.lastTimestamp?b.setRequestHeader("X-Cache-Date",a.lastTimestamp):b.setRequestHeader("X-Cache-Date",0),a.trackMessageLength&&b.setRequestHeader("X-Atmosphere-TrackMessageSize","true"),b.setRequestHeader("X-Atmosphere-tracking-id",
a.uuid),d.each(a.headers,function(c,f){var h=d.isFunction(f)?f.call(this,b,a,g,e):f;null!=h&&b.setRequestHeader(c,h)}));""!==a.contentType&&b.setRequestHeader("Content-Type",a.contentType)}function z(b,a,d){if(a.reconnect||a.suspend&&Z){var f=0;0!==b.readyState&&(f=1E3<b.status?0:b.status);e.status=0===f?204:f;e.reason=0===f?"Server resumed the connection or down.":"OK";clearTimeout(a.id);a.reconnectId&&(clearTimeout(a.reconnectId),delete a.reconnectId);0<d?setTimeout(function(){c.reconnectId=S(a)},
d):S(a)}}function na(b){b.state="re-connecting";ia(b)}function Q(b){"polling"!==b.transport?(C=ja(b),C.open()):ja(b).open()}function ja(b){var a=c;null!=b&&"undefined"!==typeof b&&(a=b);var g=a.transport,f=0,h=new window.XDomainRequest,k=function(){"long-polling"===a.transport&&a.reconnect&&(-1===a.maxRequest||a.requestCount++<a.maxRequest)&&(h.status=200,Q(a))},m=a.rewriteURL||function(a){var b=/(?:^|;\s*)(JSESSIONID|PHPSESSID)=([^;]*)/.exec(document.cookie);switch(b&&b[1]){case "JSESSIONID":return a.replace(/;jsessionid=[^\?]*|(\?)|$/,
";jsessionid="+b[2]+"$1");case "PHPSESSID":return a.replace(/\?PHPSESSID=[^&]*&?|\?|$/,"?PHPSESSID="+b[2]+"&").replace(/&$/,"")}return a};h.onprogress=function(){clearTimeout(a.id);var b=h.responseText,b=b.substring(f);f+=b.length;if("polling"!==g){H(a);var c=E(b,a,e);if("long-polling"!==g||0!==d.trim(b).length)a.executeCallbackBeforeReconnect&&k(),c||G(e.responseBody,"messageReceived",200,g),a.executeCallbackBeforeReconnect||k()}};h.onerror=function(){"polling"!==a.transport&&(p(),A++<a.maxReconnectOnClose?
0<a.reconnectInterval?a.reconnectId=setTimeout(function(){l("re-connecting",b.transport,b);Q(a)},a.reconnectInterval):(l("re-connecting",b.transport,b),Q(a)):s(0,"maxReconnectOnClose reached"))};h.onload=function(){};return{open:function(){var b=a.url;null!=a.dispatchUrl&&(b+=a.dispatchUrl);b=J(a,b);h.open(a.method,m(b));"GET"===a.method?h.send():h.send(a.data);0<a.connectTimeout&&(a.id=setTimeout(function(){0===a.requestCount&&(p(),G("Connect timeout","closed",200,a.transport))},a.connectTimeout))},
close:function(){h.abort()}}}function R(b){C=qa(b);C.open()}function qa(b){var a=c;null!=b&&"undefined"!==typeof b&&(a=b);var g,f=new window.ActiveXObject("htmlfile");f.open();f.close();var h=a.url;null!=a.dispatchUrl&&(h+=a.dispatchUrl);"polling"!==a.transport&&(e.transport=a.transport);return{open:function(){var b=f.createElement("iframe");h=J(a);""!==a.data&&(h+="&X-Atmosphere-Post-Body="+encodeURIComponent(a.data));h=d.atmosphere.prepareURL(h);b.src=h;f.body.appendChild(b);var k=b.contentDocument||
b.contentWindow.document;g=d.atmosphere.iterate(function(){try{if(k.firstChild){if("complete"===k.readyState)try{d.noop(k.fileSize)}catch(b){return G("Connection Failure","error",500,a.transport),!1}var h=k.body?k.body.lastChild:k,m=function(){var a=h.cloneNode(!0);a.appendChild(k.createTextNode("."));a=a.innerText;return a=a.substring(0,a.length-1)};if(!d.nodeName(h,"pre")){var n=k.head||k.getElementsByTagName("head")[0]||k.documentElement||k,p=k.createElement("script");p.text="document.write('<plaintext>')";
n.insertBefore(p,n.firstChild);n.removeChild(p);h=k.body.lastChild}a.closed&&(a.isReopen=!0);g=d.atmosphere.iterate(function(){var b=m();if(b.length>a.lastIndex){H(c);e.status=200;e.error=null;h.innerText="";if(E(b,a,e))return"";G(e.responseBody,"messageReceived",200,a.transport)}a.lastIndex=0;if("complete"===k.readyState)return N(!0),l("re-connecting",a.transport,a),0<a.reconnectInterval?a.reconnectId=setTimeout(function(){R(a)},a.reconnectInterval):R(a),!1},null);return!1}}catch(B){return e.error=
!0,l("re-connecting",a.transport,a),A++<a.maxReconnectOnClose?0<a.reconnectInterval?a.reconnectId=setTimeout(function(){R(a)},a.reconnectInterval):R(a):s(0,"maxReconnectOnClose reached"),f.execCommand("Stop"),f.close(),!1}})},close:function(){g&&g();f.execCommand("Stop");N(!0)}}}function aa(b){null!=u?u.send(b):null!=K||null!=x?Y(b):null!=C?c.enableXDR&&d.atmosphere.checkCORSSupport()?(b=ka(b),b.reconnect=!1,fa(b)):Y(b):null!=r?Y(b):null!=n?ra(b):(s(0,"No suspended connection available"),d.atmosphere.error("No suspended connection available. Make sure atmosphere.subscribe has been called and request.onOpen invoked before invoking this method"))}
...
d.atmosphere.callbacks.length+" global callbacks: "+e.state);try{d.each(d.atmosphere.callbacks,b)}catch(h){d.atmosphere.log(c.logLevel,["Callback exception"+h])}}if("function"===typeof c.callback){"debug"===c.logLevel&&d.atmosphere.debug("Invoking request callbacks");try{c.callback(e)}catch(k){d.atmosphere.log(c.logLevel,["Callback exception"+k])}}}}function ha(b,a){""===e.partialMessage&&"streaming"===a.transport&&b.responseText.length>a.maxStreamingLength&&(e.messages=[],N(!0),X(),p(),z(b,a,0))}
function X(){if(c.enableProtocol&&!c.firstMessage){var b="X-Atmosphere-Transport=close&X-Atmosphere-tracking-id="+c.uuid;d.each(c.headers,function(a,f){var g=d.isFunction(f)?f.call(this,c,c,e):f;null!=g&&(b+="&"+encodeURIComponent(a)+"="+encodeURIComponent(g))});var a=c.url.replace(/([?&])_=[^&]*/,b),a=a+(a===c.url?(/\?/.test(c.url)?"&":"?")+b:"");0<c.connectTimeout?d.ajax({url:a,async:!0,timeout:c.connectTimeout,cache:!1}):d.ajax({url:a,async:!0,cache:!1})}}function T(){c.reconnectId&&(clearTimeout(c.reconnectId),
delete c.reconnectId);c.reconnect=!1;I=!0;e.request=c;e.state="unsubscribe";e.responseBody="";e.status=408;w();X();p()}function p(){c.id&&clearTimeout(c.id);null!=C&&(C.close(),C=null);null!=r&&(r.abort(),r=null);null!=K&&(K.abort(),K=null);null!=n&&(n.webSocketOpened&&n.close(),n=null);null!=x&&(x.close(),x=null);null!=D&&(clearInterval(U),document.cookie=ba+"=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/",D.signal("close",{reason:"",heir:I?(D.get("children")||[])[0]:F}),D.close());null!=u&&u.close()}
var c={timeout:3E5,method:"GET",headers:{},contentType:"",callback:null,url:"",data:"",suspend:!0,maxRequest:-1,reconnect:!0,maxStreamingLength:1E7,lastIndex:0,logLevel:"info",requestCount:0,fallbackMethod:"GET",fallbackTransport:"streaming",transport:"long-polling",webSocketImpl:null,webSocketBinaryType:null,dispatchUrl:null,webSocketPathDelimiter:"@@",enableXDR:!1,rewriteURL:!1,attachHeadersAsQueryString:!0,executeCallbackBeforeReconnect:!1,readyState:0,lastTimestamp:0,withCredentials:!1,trackMessageLength:!1,
messageDelimiter:"|",connectTimeout:-1,reconnectInterval:0,dropHeaders:!0,uuid:0,shared:!1,readResponsesHeaders:!1,maxReconnectOnClose:5,enableProtocol:!0,onError:function(b){},onClose:function(b){},onOpen:function(b){},onMessage:function(b){},onReopen:function(b,a){},onReconnect:function(b,a){},onMessagePublished:function(b){},onTransportFailure:function(b,a){},onLocalMessage:function(b){},onFailureToReconnect:function(b,a){},onClientTimeout:function(b){}},e={status:200,reasonPhrase:"OK",responseBody:"",
messages:[],headers:[],state:"messageReceived",transport:"polling",error:null,request:null,partialMessage:"",errorHandled:!1,closedByClientTimeout:!1},n=null,x=null,K=null,C=null,r=null,Z=!0,A=0,I=!1,P=null,D,u=null,F=d.now(),U,ba;k(h);this.subscribe=function(b){k(b);g()};this.execute=function(){g()};this.invokeCallback=function(){w()};this.close=function(){T()};this.disconnect=function(){X()};this.getUrl=function(){return c.url};this.push=function(b,a){if(null!=a){var d=c.dispatchUrl;c.dispatchUrl=
...
return d.atmosphere.requests[d.atmosphere.requests.length]=h},addCallback:function(h){-1===d.inArray(h,d.atmosphere.callbacks)&&d.atmosphere.callbacks.push(h)},removeCallback:function(h){h=d.inArray(h,d.atmosphere.callbacks);-1!==h&&d.atmosphere.callbacks.splice(h,1)},unsubscribe:function(){if(0<d.atmosphere.requests.length)for(var h=[].concat(d.atmosphere.requests),k=0;k<h.length;k++){var g=h[k];g.close();clearTimeout(g.response.request.id)}d.atmosphere.requests=[];d.atmosphere.callbacks=[]},unsubscribeUrl:function(h){var k=
-1;if(0<d.atmosphere.requests.length)for(var g=0;g<d.atmosphere.requests.length;g++){var t=d.atmosphere.requests[g];if(t.getUrl()===h){t.close();clearTimeout(t.response.request.id);k=g;break}}0<=k&&d.atmosphere.requests.splice(k,1)},publish:function(h){"function"===typeof h.callback&&d.atmosphere.addCallback(h.callback);h.transport="polling";h=new d.atmosphere.AtmosphereRequest(h);return d.atmosphere.requests[d.atmosphere.requests.length]=h},checkCORSSupport:function(){return d.browser.msie&&!window.XDomainRequest||
d.browser.opera&&12>+d.browser.version.split(".")[0]||"KreaTVWebKit/531"===d.trim(navigator.userAgent).slice(0,16)||"kreatel"===d.trim(navigator.userAgent).slice(-7).toLowerCase()?!0:-1<navigator.userAgent.toLowerCase().indexOf("android")?!0:!1},S4:function(){return(65536*(1+Math.random())|0).toString(16).substring(1)},guid:function(){return d.atmosphere.S4()+d.atmosphere.S4()+"-"+d.atmosphere.S4()+"-"+d.atmosphere.S4()+"-"+d.atmosphere.S4()+"-"+d.atmosphere.S4()+d.atmosphere.S4()+d.atmosphere.S4()},
prepareURL:function(h){var k=d.now(),g=h.replace(/([?&])_=[^&]*/,"$1_="+k);return g+(g===h?(/\?/.test(h)?"&":"?")+"_="+k:"")},param:function(h){return d.param(h,d.ajaxSettings.traditional)},supportStorage:function(){var h=window.localStorage;if(h)try{return h.setItem("t","t"),h.removeItem("t"),window.StorageEvent&&!d.browser.msie&&!(d.browser.mozilla&&"1"===d.browser.version.split(".")[0])}catch(k){}return!1},iterate:function(d,k){var g;k=k||0;(function O(){g=setTimeout(function(){!1!==d()&&O()},
k)})();return function(){clearTimeout(g)}},log:function(d,k){if(window.console){var g=window.console[d];"function"===typeof g&&g.apply(window.console,k)}},warn:function(){d.atmosphere.log("warn",arguments)},info:function(){d.atmosphere.log("info",arguments)},debug:function(){d.atmosphere.log("debug",arguments)},error:function(){d.atmosphere.log("error",arguments)},isBinary:function(d){return/^\[object\s(?:Blob|ArrayBuffer|.+Array)\]$/.test(Object.prototype.toString.call(d))}};(function(){var h,k;
d.uaMatch=function(d){d=d.toLowerCase();d=/(chrome)[ \/]([\w.]+)/.exec(d)||/(webkit)[ \/]([\w.]+)/.exec(d)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(d)||/(msie) ([\w.]+)/.exec(d)||/(trident)(?:.*? rv:([\w.]+)|)/.exec(d)||0>d.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(d)||[];return{browser:d[1]||"",version:d[2]||"0"}};h=d.uaMatch(navigator.userAgent);k={};h.browser&&(k[h.browser]=!0,k.version=h.version);k.chrome?k.webkit=!0:k.webkit&&(k.safari=!0);k.trident&&(k.msie=!0);d.browser=
k;d.sub=function(){function g(d,h){return new g.fn.init(d,h)}d.extend(!0,g,this);g.superclass=this;g.fn=g.prototype=this();g.fn.constructor=g;g.sub=this.sub;g.fn.init=function(k,l){l&&l instanceof d&&!(l instanceof g)&&(l=g(l));return d.fn.init.call(this,k,l,h)};g.fn.init.prototype=g.fn;var h=g(document);return g}})();(function(d){function k(d){return'"'+d.replace(O,function(d){var g=l[d];return"string"===typeof g?g:"\\u"+("0000"+d.charCodeAt(0).toString(16)).slice(-4)})+'"'}function g(d){return 10>
d?"0"+d:d}function t(d,h){var l,M,q,m=h[d];q=typeof m;m&&"object"===typeof m&&"function"===typeof m.toJSON&&(m=m.toJSON(d),q=typeof m);switch(q){case "string":return k(m);case "number":return isFinite(m)?String(m):"null";case "boolean":return String(m);case "object":if(!m)return"null";switch(Object.prototype.toString.call(m)){case "[object Date]":return isFinite(m.valueOf())?'"'+m.getUTCFullYear()+"-"+g(m.getUTCMonth()+1)+"-"+g(m.getUTCDate())+"T"+g(m.getUTCHours())+":"+g(m.getUTCMinutes())+":"+g(m.getUTCSeconds())+
'Z"':"null";case "[object Array]":M=m.length;q=[];for(l=0;l<M;l++)q.push(t(l,m)||"null");return"["+q.join(",")+"]";default:q=[];for(l in m)Object.prototype.hasOwnProperty.call(m,l)&&(M=t(l,m))&&q.push(k(l)+":"+M);return"{"+q.join(",")+"}"}}}var O=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};d.stringifyJSON=function(d){return window.JSON&&window.JSON.stringify?
window.JSON.stringify(d):t("",{"":d})}})(d)});